...
import com.repayment.exception.BeanValidationException;
...
public class BindingResultAspect {
	...
	@Before("@annotation(com.repayment.aspect.CheckBindingResult) && args (..,bindingResult)")
